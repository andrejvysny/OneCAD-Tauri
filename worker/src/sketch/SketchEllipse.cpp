// Ported from OneCAD-CPP src/core/sketch/SketchEllipse.cpp @ b4ddcccc (2026-07-16)
...
BoundingBox2d SketchEllipse::boundsWithCenter(const gp_Pnt2d& centerPos) const {
    ...
    // W-WP3a: removed unused cosR/sinR (dead in original; sampling below uses
    // pointAtParameter which recomputes rotation). Algorithm unchanged.
